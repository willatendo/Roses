...
public class ServerConfig 
{
	...
	{
		enableRoses = builder.comment("Sets if the roses should be enabled.").translation(TRANSLATION_TEXT + "enableRoses").define("enableRoses", true);
		...
		enableCyanFlowers = builder.comment("Sets if the cyan flowers should be enabled.").translation(TRANSLATION_TEXT + "enableCyanFlowers").define("enableCyanFlowers", true);
		...
		cyanFlowerBiomes = builder.comment("Sets the biomes cyan flower patches will spawn in.").translation(TRANSLATION_TEXT + "cyanFlowerBiomes").defineList("cyanFlowerBiomes", Lists.newArrayList("minecraft:plains"), o -> o instanceof String);
	}
}
