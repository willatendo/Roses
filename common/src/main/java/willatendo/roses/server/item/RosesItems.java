...
public class RosesItems {
    ...
    public static final SimpleHolder<Item> MUSIC_DISC_MAGNETIC_CIRCUIT = ITEMS.register("music_disc_magnetic_circuit", () -> new RecordItem(1, RosesSounds.MAGNETIC_CIRCUIT.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 3860));
